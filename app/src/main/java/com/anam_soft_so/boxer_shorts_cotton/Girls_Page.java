...
public class Girls_Page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_girls_page);
        gridView=findViewById(R.id.gridView);
        progress=findViewById(R.id.progress);
        back=findViewById(R.id.back);


        String url ="https://anamhr.xyz/eapp/girls.json";
        ...
        RequestQueue requestQueue= Volley.newRequestQueue(Girls_Page.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(Girls_Page.this,MainActivity.class);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            card.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent =new Intent(Girls_Page.this,AboutP.class);
                    startActivity(intent);
                    AboutP.NAME=Name ;
                    AboutP.IMG=Img;
                    AboutP.PURL=Purl;
